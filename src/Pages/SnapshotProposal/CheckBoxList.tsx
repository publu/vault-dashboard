...
export default function CheckboxList(props: {
    ...
    setChecked: React.Dispatch<React.SetStateAction<(GAUGE_VALID_COLLATERAL | GAUGE_VALID_COLLATERAL_V2)[]>>
}) {
    const { choices, checked, setChecked } = props
    const handleToggle = (value: GAUGE_VALID_COLLATERAL | GAUGE_VALID_COLLATERAL_V2) => () => {
