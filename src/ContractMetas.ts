...
export const Contracts: { [chainId in ChainIdKey]?: ContractMeta[] } = {
    ...
    //     { label: 'WETH', address: '0xa9122dacf3fccf1aae6b8ddd1f75b6267e5cbbb8', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'WBTC', address: '0x1f8f7a1d38e41eaf0ed916def29bdd13f2a3f11a', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'WAVAX', address: '0x73a755378788a4542a780002a75a7bae7f558730', abi: Erc20QiStablecoin__factory.abi },
    // ],
    // [ChainId.ARBITRUM]: [
    //     { label: 'WETH', address: '0xC76a3cBefE490Ae4450B2fCC2c38666aA99f7aa0', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'WBTC', address: '0xB237f4264938f0903F5EC120BB1Aa4beE3562FfF', abi: Erc20QiStablecoin__factory.abi },
    // ],
    // [ChainId.MOONRIVER]: [
    //     { label: 'ETH', address: '0x4a0474E3262d4DB3306Cea4F207B5d66eC8E0AA9', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'ETH-USDC LP', address: '0x97D811A7eb99Ef4Cb027ad59800cE27E68Ee1109', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'MOVR', address: '0x5db6617ddf077d76cfd9d7fc0fa91aaabc3da683', abi: Erc20QiStablecoin__factory.abi },
    // ],
    // [ChainId.HARMONY]: [
    //     { label: 'WETH', address: '0x46469f995A5CB60708200C25EaD3cF1667Ed36d6', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'ONE', address: '0x12FcB286D664F37981a42cbAce92eAf28d1dA94f', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'WBTC', address: '0x9f4E3d01c634441F284beb92bBAEeb76133BbB28', abi: Erc20QiStablecoin__factory.abi },
    // ],
    // [ChainId.XDAI]: [
    //     { label: 'WETH', address: '0x5c49b268c9841AFF1Cc3B0a418ff5c3442eE3F3b', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'GNO', address: '0x014a177e9642d1b4e970418f894985dc1b85657f', abi: Erc20QiStablecoin__factory.abi },
    // ],
    // [ChainId.OPTIMISM]: [
    //     { label: 'WETH', address: '0x062016cd29fabb26c52bab646878987fc9b0bc55', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'WBTC', address: '0xb9c8f0d3254007ee4b98970b94544e473cd610ec', abi: Erc20QiStablecoin__factory.abi },
    // ],
    // [ChainId.BSC]: [
    //     { label: 'WBNB', address: '0xa56f9a54880afbc30cf29bb66d2d9adcdcaeadd6', abi: Erc20QiStablecoin__factory.abi },
    //     { label: 'CAKE', address: '0x014a177e9642d1b4e970418f894985dc1b85657f', abi: Erc20QiStablecoin__factory.abi },
    // ]
}
