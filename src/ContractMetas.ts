...
export const Contracts: { [chainId in ChainIdKey]?: ContractMeta[] } = {
    [ChainId.MATIC]: [
        ...
        { label: 'WBTC', address: '0x37131aEDd3da288467B6EBe9A77C523A700E6Ca1', abi: Erc20QiStablecoin__factory.abi, decimals: 1e8 },
        ...
        { label: 'camWBTC', address: '0x7dda5e1a389e0c1892caf55940f5fce6588a9ae0', abi: Erc20QiStablecoin__factory.abi, decimals: 1e8},
    ...
    [ChainId.FANTOM]: [
        ...
        { label: 'yvBTC', address: '0x571F42886C31f9b769ad243e81D06D0D144BE7B4', abi: Erc20QiStablecoin__factory.abi, decimals: 1e8 },
        { label: 'yvYFI', address: '0x6d6029557a06961aCC5F81e1ffF5A474C54e32Fd', abi: Erc20QiStablecoin__factory.abi },
        { label: 'BTC', address: '0xE5996a2cB60eA57F03bf332b5ADC517035d8d094', abi: CrosschainQiStablecoinwbtc__factory.abi, decimals: 1e8 },
        ...
        {label: 'mooScreamBTC', address: '0x5563Cc1ee23c4b17C861418cFF16641D46E12436', abi: Erc20QiStablecoin__factory.abi, decimals: 1e8},
    ...
    [ChainId.AVALANCHE]: [
        ...
        { label: 'WBTC', address: '0x1f8f7a1d38e41eaf0ed916def29bdd13f2a3f11a', abi: CrosschainQiStablecoinSlimV2__factory.abi, decimals: 1e8 },
    ...
    [ChainId.ARBITRUM]: [
        ...
        { label: 'WBTC', address: '0xB237f4264938f0903F5EC120BB1Aa4beE3562FfF', abi: CrosschainQiStablecoinSlimV2__factory.abi, decimals: 1e8 },
    ],
    [ChainId.MOONRIVER]: [
    ...
    [ChainId.HARMONY]: [
        ...
        { label: 'WBTC', address: '0x9f4E3d01c634441F284beb92bBAEeb76133BbB28', abi: CrosschainQiStablecoin__factory.abi, decimals: 1e8 }, //Guessed abi
    ],
    [ChainId.XDAI]: [
    ...
    [ChainId.OPTIMISM]: [
        ...
        { label: 'WBTC', address: '0xb9c8f0d3254007ee4b98970b94544e473cd610ec', abi: CrosschainQiStablecoinSlimV2__factory.abi, decimals: 1e8 },
    ],
    [ChainId.BSC]: [
