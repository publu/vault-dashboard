...
export type VaultContractSlim = CrosschainQiStablecoinSlim | CrosschainQiStablecoinSlimV2
...
export type VaultContract = QiStablecoin | VaultContractV1 | VaultContractSlim | VaultContractV2

export function isV2Contract(vaultContract: VaultContract): vaultContract is VaultContractV2 {
    return (vaultContract as VaultContractV2).iR !== undefined
}

export function isSlimContract(vaultContract: VaultContract): vaultContract is VaultContractSlim {
