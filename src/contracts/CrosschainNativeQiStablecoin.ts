...
export interface CrosschainNativeQiStablecoinInterface extends utils.Interface {
  functions: {
    ...
    "depositNative(uint256)": FunctionFragment;
...
export interface CrosschainNativeQiStablecoin extends BaseContract {
  ...
  interface: CrosschainNativeQiStablecoinInterface;
