...
export interface Erc20QiStablecoinInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "transferToken(uint256)",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface Erc20QiStablecoin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Erc20QiStablecoinInterface;
