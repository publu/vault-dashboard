...
export const getBlockNumbersFromTS = async (timestamp: Date | number, chainId: ChainId) => {
...
export const useBlockNumbersFromTS = (timestamp: Date | number, chainId: ChainId) => {
    //"10", "25", "100", "137", "250", "1285", "42161", "43114", "1666600000"
