...
const builders = {
    ...
    moonbeam: (chainName: string, data: string, type: 'transaction' | 'token' | 'address' | 'block') => {
    ...
    cronos: (chainName: string, data: string, type: 'transaction' | 'token' | 'address' | 'block') => {
    ...
    optimism: (chainName: string, data: string, type: 'transaction' | 'token' | 'address' | 'block') => {
    ...
    metis: (chainName: string, data: string, type: 'transaction' | 'token' | 'address' | 'block') => {
